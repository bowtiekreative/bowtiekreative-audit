    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-3 text-xl font-bold text-white">Bowtie Kreative</span>
            </div>
            <p className="text-gray-400 mb-4">
              Empowering businesses with comprehensive digital marketing audits and strategic insights.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>© {currentYear} Bowtie Kreative. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
